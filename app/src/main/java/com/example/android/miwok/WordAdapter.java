...
// Find the TextView in the list_item.xml layout with the ID for the Miwok word
        ...
        TextView miwokTextView = (TextView) convertView.findViewById(R.id.miwok_text_view);  // warning messages say casting to TextView is redundant.  Will retest by removing the cast

// Get the version name from the current word object and set this text on miwokTextView
